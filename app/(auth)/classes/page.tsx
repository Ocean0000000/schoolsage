...
export default function ClassesPage() {
  ...
  return (
    <>
      <h1 className="mx-52 mt-8 text-5xl font-bold">Classes</h1>
      <div className="mx-52 mt-4 border-4 border-gray-background"></div>
      <section className="grid grid-cols-3 gap-4 mt-12 mx-52">
        <div className="p-4 border rounded shadow">Class 1</div>
        <div className="p-4 border rounded shadow">Class 2</div>
        <div className="p-4 border rounded shadow">Class 3</div>
        <div className="p-4 border rounded shadow">Class 4</div>
      </section>
      <div
        ref={profileDropdownRef}
        className="flex flex-col items-center absolute top-8 right-8"
      >
        <button
          type="button"
        ...
        {isProfileDropdownOpen && (
          <div className="flex justify-center relative mt-2">
            <button
              type="button"
              className="btn btn-primary cursor-pointer border px-4 py-2 absolute"
